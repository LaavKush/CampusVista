...
const HeroSection = () => {
  ...
  // ✅ Define admin emails globally so both functions can access it
  ...
  const handleExploreClick = () => {
    ...
    if (user) {
      ...
      if (adminEmails.includes(user.email)) {
        console.log("🛠 Admin detected → Navigating to Admin Dashboard");
        navigate("/admin-dashboard"); // internal route (same domain)
      } else {
        console.log("🎓 Regular user → Navigating to Campus Explore");
        window.location.href = "https://campus-explore.vercel.app/"; // external domain
      }
    } else {
      console.log("User is null → opening signup modal");
      openSignupModal();
  ...
  return (
    ...
    >
      ...
      <SignupModal
        ...
        onSuccess={() => {
          console.log("✅ Signup successful → navigating correctly");
          closeSignupModal();

          if (user && adminEmails.includes(user.email)) {
            console.log("Admin after signup → navigating to Admin Dashboard");
            navigate("/admin-dashboard");
          } else {
            console.log("Student after signup → navigating to Campus Explore");
            window.location.href = "https://campus-explore.vercel.app/";
          }
        }}
      />
